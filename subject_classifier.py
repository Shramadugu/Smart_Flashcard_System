...
def detect_subject(text: str) -> str:
    ...
    keywords = {
        ...
        "Maths": ["algebra", "geometry", "equation", "derivative", "integral", "calculus"],
...
if __name__ == "__main__":
    question = "What causes gravity to affect objects?"
    subject = detect_subject(question)
    print("Detected Subject:", subject)  # Expected output: Physics